...
def listen_after(func):
    """Decorator to listen to all messages after func is executed."""
    broadcast = Broadcast()
...
def listen_before(func):
    """Decorator to listen to all messages before func is executed."""
    broadcast = Broadcast()
...
def listen_wrapped(func):
    """Decorator to listen to all messages before and after func is executed."""
    broadcast = Broadcast()
...
def listen_one_before(func):
    """Decorator to listen to one message before func is executed."""
    broadcast = Broadcast()
...
def listen_one_after(func):
    """Decorator to listen to one message after func is executed."""
    broadcast = Broadcast()
